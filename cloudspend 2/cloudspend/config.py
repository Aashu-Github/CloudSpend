...
class Settings:
    ...
    cors_origins: str = "https://aashu-github.github.io,http://127.0.0.1:8000,http://localhost:8000"
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            cors_origins=os.getenv("CORS_ORIGINS", "https://aashu-github.github.io,http://127.0.0.1:8000,http://localhost:8000"),
        )
